...
const reseniaRoutes = require('./routes/reseniaRoutes'); // <-- ¡Habilitado!
...
app.use('/api/resenias', reseniaRoutes); // <-- ¡Habilitado!

// Ruta base de prueba para el navegador
app.get('/', (req, res) => {
  res.send('Servidor de CineTrack corriendo impecable 🚀');
});

// Sincronizar Base de Datos y arrancar el servidor
sequelize.sync({ force: false }) 
  .then(() => {
    console.log('📌 Base de datos SQLite y tablas sincronizadas con éxito.');
    app.listen(PORT, () => {
